    ...
    <div class="exam-shell">
      <div class="exam-intro">
        ...
        <div class="exam-actions">
          <button class="action-button primary" type="button" data-score-button="true" onclick="window.scoreExamById('${exam.id}'); return false;">Score Exam</button>
          <button class="action-button secondary" type="button" data-reset-button="true" onclick="window.resetExamById('${exam.id}'); return false;">Reset</button>
...
window.activateStudyTab = function(target) {
  var activeButton = tabButtons.find(function(item) {
    return item.dataset.tabTarget === target;
  });
  if (activeButton) {
    activateTab(target, activeButton);
  }
  return false;
};

window.scoreExamById = function(id) {
...
window.resetExamById = function(id) {
  var panel = document.querySelector('[data-tab-panel="' + id + '"]');
  if (panel) {
    resetExam(panel);
  }
